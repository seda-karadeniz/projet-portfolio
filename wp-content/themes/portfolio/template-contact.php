    ...
    <main class="layout contact" itemscope itemtype="https://schema.org/Person">
        ...
        <aside class="contact__info">
            <div class="contact__info-num">
                <a href="tel:<?= get_field('telephone'); ?>" itemprop="telephone"><?= get_field('telephone'); ?></a>
            </div>
            <div class="contact__info-email">
                <a href="mailto:<?= get_field('email'); ?>" itemprop="email"><?= get_field('email'); ?></a>
            </div>
            <div class="contact__info-rs">
                <!-- dribbble-->
                ...
                <!-- github-->
                <a href="https://github.com/seda-karadeniz">
                ...
                <!--instagram-->
                <a href="https://www.instagram.com/sda_krdnz">
                ...
                <!-- linledn-->
                <a href="https://www.linkedin.com/in/seda-karadeniz-0a92251ba/">
